...
$(document).ready(function () {
    ...
    tablaData = $('#tbdata').DataTable({
        ...
        "columns": [
            { "data": "idContacto", "visible": false, "searchable": false },
            {
...
function mostrarModal(modelo = MODELO_BASE) {
    $("#txtId").val(modelo.idContacto)
    $("#txtNombres").val(modelo.nombres)
    $("#txtDireccion").val(modelo.direccion)
    $("#txtFecha_Nac").val(modelo.fecha_nac)
    $("#txtTelefono").val(modelo.telefono)
    $("#txtImagen").val("")
    $("#imgContacto").attr("src", modelo.urlImagen)
...
$("#btnGuardar").click(function () {
    ...
    modelo["idContacto"] = parseInt($("#txtId").val())
    modelo["nombres"] = $("#txtNombres").val()
    modelo["direccion"] = $("#txtDireccion").val()
    modelo["fecha_nac"] = $("#txtFecha_Nac").val()
        ...
        fetch('Home/GuardarCambios', {
            ...
            .then(responseJson => {
                if (responseJson.estado) {
                    ...
                    swal("Listo!", "El contacto fue creado correctamente", "success")
                } else {
    ...
    swal({
        ...
        function (respuesta) {
            ...
            if (respuesta) {
                ...
                fetch(`/Contacto/Eliminar?Id=${data.id}`, {
                    method: "DELETE"
                })
                    .then(response => {
